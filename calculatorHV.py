...
buttonDivision = tk.Button(root, text="÷", bg="light blue", command=lambda: insertInput("/"))  # Bug 2 
...
buttonEquals = tk.Button(root, text="=", bg="light green", command=lambda: evaluateResult()) 
...
button7.grid(row=3, column=4, sticky="NESW")
...
buttonClear.config(command=lambda: clear())  
